...
function App() {
  ...
  return ( <div className="bg-zinc-800 h-screen justify-center flex items-center ">
    ...
    <div className="flex juatify-center px-12 py-7 items-center flex-col ">
      ...
      <h2 className="bg-gradient-to-r from-green-600 via-slate-100 to-pink-400 bg-clip-text text-3xl tracking-tight text-transparent">Using React and Readux</h2>
      </div>
